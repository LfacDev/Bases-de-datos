        ...
        <div class="container-fluid">
            <div class="row">
                <form method="POST" action="../Controladores/ControladorCliente.php" class="col-6">
                    ...
                    <input type="text" class="form-control col-10" placeholder="Cedula" aria-label="Cedula" name="cedula" />
                    <br>
                    <h2 class="h4 mb-3 text-gray-800">Nombre</h2>
                    <input type="text" class="form-control col-10" placeholder="Nombre" aria-label="Nombre" name="nombre"/>
                    <br>
                    <h2 class="h4 mb-3 text-gray-800">Apellidos</h2>
                    <input type="text" class="form-control col-10" placeholder="Apellidos" aria-label="Apellidos" name="apellidos"/>
                    <br>
                    <h2 class="h4 mb-3 text-gray-800">Direccion</h2>
                    <input type="text" class="form-control col-10" placeholder="Direccion" aria-label="Direccion" name="direccion"/>
                    <br>
                    ...
                    <br>
                    <p></p>
                    <button type="submit" class="btn btn-success col-4 btn-lg">Enviar</button>
                </form>
                <div class="col-6">
                <h2>Mapa</h2>
                <div id="miMapa"></div>
